...
def main():
    coldFile = glob.glob('/Volumes/Macintosh HD/Users/liam_msg/Documents/automate_MSG_automate_recharge/temp/20c*')[0]
    roomFile = glob.glob('/Volumes/Macintosh HD/Users/liam_msg/Documents/automate_MSG_automate_recharge/temp/4c*')[0]
